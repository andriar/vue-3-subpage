<template>
  <div class="flex flex-col gap-8">
    ...
    <div
      class="flex flex-col items-start justify-center gap-8 rounded-xl border border-gray-300 bg-gray-200 p-6"
    >
      <p class="text-xs text-gray-800">
        Build your Qiscus Live Chat based on your need using our builder.
      </p>

      <div class="flex w-full flex-col gap-2 lg:w-140">
    ...
    >
      <div class="flex flex-col items-start gap-2 text-sm">
        <h5 class="text-black-700 font-semibold">Term of condition</h5>
      ...
      <Banner intent="positive" class="text-black-700 text-sm leading-5 font-medium">
